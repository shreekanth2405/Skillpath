...
const EnglishLearning = () => {
    ...
    const handleAIVisionResponse = useCallback(async (text) => {
        ...
        try {
            ...
            const prompt = `Act as Emma, a friendly AI English Tutor Assistant.
User input: "${text}"
...
Task:
1. One encouraging conversational response (2 sentences).
...
Stay professional and warm. Plain text only.`;
    ...
    }, [isProcessing, isCameraOn, isCameraActive]);
    ...
    const speakResponse = (text) => {
        ...
        const preferred = voices.find(v => v.name.includes("Google US") || v.name.includes("Female") || v.lang === "en-US");
    ...
    return (
        <div className="voice-tutor-interaction-page" style={{
            ...
            <div className="tutor-avatar-tier" style={{ textAlign: 'center' }}>
                ...
                <h2 style={{ fontSize: '1.6rem', fontWeight: '800', margin: 0 }}>Emma Assistant</h2>
                <div style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: '8px',
