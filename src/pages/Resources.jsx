                            ...
                            <div key={i} style={{ marginBottom: '4rem' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '2rem' }}>
                                    {subj.books.map((book, j) => (
                                        <motion.div key={j} whileHover={{ y: -10 }} onClick={() => navigate('/book-reader')} className="hover-3d" style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', border: '1px solid #e2e8f0', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.05)', cursor: 'pointer', display: 'flex', flexDirection: 'column', transition: '0.3s' }}>
