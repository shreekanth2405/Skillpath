...
const seedJobs = async () => {
    try {
        ...
        const mockJobs = [
            ...
            {
                sourceUrl: 'https://tesla.com/careers/5',
                sourceDomain: 'tesla.com',
                companyName: 'Tesla',
                jobTitle: 'AI Autopilot Intern',
                location: ['Palo Alto', 'CA'],
                experienceRequired: 'Student',
                skillsRequired: ['C++', 'Python', 'Computer Vision', 'PyTorch'],
                rawDescription: 'Help us build the future of autonomous driving...',
                salaryEstimate: '$40 - $60 / hr',
                country: 'USA',
                isInternship: true,
